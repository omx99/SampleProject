...
public class RAQinCHROME {
	...
	public static void main(String[] args) throws BiffException, IOException {
		...
		System.setProperty("webdriver.chrome.driver", "C:\\Users\\Admin !\\ADMIN\\chromedriver.exe" );
		WebDriver driver = new ChromeDriver();
		
		
		String mainUrl = "http://www.mbusa.com";
		
		String GNRAQurl ="/mercedes/contact_us/request_a_quote";
		
		driver.get(mainUrl+GNRAQurl);
	...
	//abcd.selectByIndex(3);
		...
		WebElement e = driver.findElement(By.xpath(S.getCell(2,1).getContents()));//selected the part
